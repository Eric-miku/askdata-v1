"""PostgreSQL database adapter for registered AskData databases."""
...
class PostgreSQLAdapter(DatabaseAdapter):
    ...
    def __init__(self, url: str = "", *, engine=None):
        self.url = url
        self._engine = engine
        self.validator = SQLValidator(dialect="postgres")
    ...
    def engine(self):
        if self._engine is None:
            ...
            if not self.url:
                raise ValueError("PostgreSQLAdapter requires url or injected engine")
